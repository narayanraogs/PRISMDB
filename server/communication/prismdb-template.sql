...
INSERT INTO "Devices" ("ID", "DeviceName", "DeviceMake", "DeviceType", "IPAddress", "ControlPort", "AlternateControlPort", "ReadPort", "DopplerPort", "TimeoutInMillisecs") VALUES (4,'SpectrumAnalyzer','N9030B','SA','172.20.x.60',5025,5125,0,0,5000);
...
INSERT INTO "Devices" ("ID", "DeviceName", "DeviceMake", "DeviceType", "IPAddress", "ControlPort", "AlternateControlPort", "ReadPort", "DopplerPort", "TimeoutInMillisecs") VALUES (6,'VSA','N9040B','VSA','172.20.x.61',5025,5125,0,0,5000);
INSERT INTO "Devices" ("ID", "DeviceName", "DeviceMake", "DeviceType", "IPAddress", "ControlPort", "AlternateControlPort", "ReadPort", "DopplerPort", "TimeoutInMillisecs") VALUES (7,'PPM','NRX','PPM','172.20.x.59',5025,0,0,0,5000);
INSERT INTO "Devices" ("ID", "DeviceName", "DeviceMake", "DeviceType", "IPAddress", "ControlPort", "AlternateControlPort", "ReadPort", "DopplerPort", "TimeoutInMillisecs") VALUES (8,'VSG','E8267D','VSG','172.20.x.67',5025,0,0,0,5000);
INSERT INTO "DeviceProfile" ("ID", "DeviceProfileName", "SAName", "VSAName", "PMName", "PPMName", "TSMName", "GTxName", "SGName", "VSGName") VALUES (1,'Default','SpectrumAnalyzer','VSA','PowerMeter','PPM','SDU&TSM','Cortex-Main','SignalGenerator','VSG');
INSERT INTO "FrequencyProfile" ("ID", "Name", "MaxFrequency", "StepSize", "CommandingRequired", "DopplerFile") VALUES (1,'CarrierAcq-Extreme',125000.0,125000.0,'Yes','/umacsops/prism/doppler/doppler.csv');
INSERT INTO "FrequencyProfile" ("ID", "Name", "MaxFrequency", "StepSize", "CommandingRequired", "DopplerFile") VALUES (2,'CarrierAcq-Normal',125000.0,25000.0,'Yes','/umacsops/prism/doppler/doppler.csv');
INSERT INTO "FrequencyProfile" ("ID", "Name", "MaxFrequency", "StepSize", "CommandingRequired", "DopplerFile") VALUES (3,'LoopStress-Extreme',125000.0,125000.0,'No','/umacsops/prism/doppler/doppler.csv');
INSERT INTO "FrequencyProfile" ("ID", "Name", "MaxFrequency", "StepSize", "CommandingRequired", "DopplerFile") VALUES (4,'LoopStress-Normal',125000.0,25000.0,'No','/umacsops/prism/doppler/doppler.csv');
INSERT INTO "PowerProfile" ("ID", "Name", "PowerLevels", "NoOfCommandsAtThreshold", "NoOfCommandsAtOtherLevels") VALUES (1,'RxNominal','-85', 100, 10);
INSERT INTO "PowerProfile" ("ID", "Name", "PowerLevels", "NoOfCommandsAtThreshold", "NoOfCommandsAtOtherLevels") VALUES (2,'CarrierAcquisition','-85', 100, 10);
...
INSERT INTO "TSMConfigurations" VALUES (30,'PL-Sample',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
