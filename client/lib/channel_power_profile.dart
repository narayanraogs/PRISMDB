...
class OBWPowerProfile extends StatefulWidget {
  final Global global;
  final VoidCallback callback;

  const OBWPowerProfile(this.global, this.callback, {super.key});

  @override
  State<OBWPowerProfile> createState() => StateOBWPowerProfile();
}

class StateOBWPowerProfile extends State<OBWPowerProfile> {
  final _formKey = GlobalKey<FormState>();
  TextEditingController _nameController = TextEditingController();
  TextEditingController _occupiedBW = TextEditingController();
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (temp.ok) {
          ...
          _occupiedBW.text = temp.values[1];
          setState(() {});
        } else {
  ...
  List<Widget> getChildren(BuildContext context) {
    ...
    children.add(_buildTextField(
      ...
      label: "OBW Power Profile Name",
      validator: (value) {
        if (value == null || value.trim().isEmpty) {
          return "OBW Power Profile name cannot be empty";
        }
        return null;
      },
    ));
    ...
    children.add(_buildTextField(
      controller: _occupiedBW,
      label: "Occupied Bandwidth",
      validator: (value) {
        if (value == null || value.trim().isEmpty) {
          return "Occupied Bandwidth cannot be empty";
        }
  ...
  void update(bool edit) async {
    ...
    values.add(getInt(_occupiedBW.text));
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
             ...
             child: Text(
               widget.global.rowSelected.isEmpty ? "Create Power Profile" : "Edit Power Profile", 
